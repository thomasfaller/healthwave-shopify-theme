...
var bcSfFilterTemplate = {
  ...
  // Grid Template
  'productGridItemHtml': '<div class="grid__item one-quarter text-center">' +
...
BCSfFilter.prototype.buildProductGridItem = function (data, index) {
  ...
  var itemPriceHtml = '';
  if (data.title != '') {
    itemPriceHtml += '<p class="grid-link__meta text-muted">'; // ! modified to apply some BootStrap styling ;)
    if (onSale) {
